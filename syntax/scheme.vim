...
" Patch:  Evan Hanson (http://evanhanson.com/misc/editing-scheme-with-vim/)
...
syn region schemeQuoted matchgroup=Normal start="['`]" end=![ \t()\[\]";]!me=e-1 contains=ALLBUT,schemeStruc,schemeSyntax,schemeFunc
...
syn region schemeUnquote matchgroup=schemeParentheses start="," end=![ \t\[\]()";]!me=e-1 contains=ALLBUT,schemeStruc,schemeSyntax,schemeFunc
syn region schemeUnquote matchgroup=schemeParentheses start=",@" end=![ \t\[\]()";]!me=e-1 contains=ALLBUT,schemeStruc,schemeSyntax,schemeFunc

syn region schemeUnquote matchgroup=schemeParentheses start=",(" end=")" contains=ALL
syn region schemeUnquote matchgroup=schemeParentheses start=",@(" end=")" contains=ALL
...
syn region schemeStruc matchgroup=schemeParentheses start="(" matchgroup=schemeParentheses end=")" contains=ALL
syn region schemeStruc matchgroup=schemeParentheses start="#(" matchgroup=schemeParentheses end=")" contains=ALL
...
" Let's not error here, to allow for things like -identifiers-that-start-with-a-dash.
syn match schemeOther ![-#+0-9.][-#+/0-9a-f@i.boxesfdl]*[^-#+/0-9a-f@i.boxesfdl \t\[\]()";][^ \t\[\]()";]*!
...
if version >= 508 || !exists("did_scheme_syntax_inits")
  ...
  HiLink schemeParentheses		Comment
